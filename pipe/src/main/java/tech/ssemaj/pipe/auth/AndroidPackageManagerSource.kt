...
/** Real [PackageManagerSource] backed by [PackageManager]. Never throws. */
internal class AndroidPackageManagerSource(context: Context) : PackageManagerSource {
    ...
    override fun serviceResolvable(component: ComponentName): Boolean = try {
        if (API33) pm.getServiceInfo(component, PackageManager.ComponentInfoFlags.of(0)) != null
        else @Suppress("DEPRECATION") pm.getServiceInfo(component, 0) != null
